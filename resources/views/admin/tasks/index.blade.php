...
<body>
    ...
    <div class="container">
        ...
        <a href="{{ route('admin.taskshow') }}" class="btn btn-secondary mb-3">Show Completed Tasks</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if (!$task->completed)
                        <form action="{{ route('admin.tasks.complete', $task->id) }}" method="POST" style="display: inline;">
                            @csrf
